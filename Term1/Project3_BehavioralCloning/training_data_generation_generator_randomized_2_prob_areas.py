...
def shuffle_driving_log():
    ...
    driving_log = pd.read_csv('training_data/Prob_Areas/driving_log.csv', header=None)
    ...
    driving_log.to_csv('training_data/Prob_Areas/shuffled_driving_log.csv', sep=',', header=False, index=False) #comma separated
...
def generate_data_generator(batch_size=16,straight_steer_discard_prob_th=0):
    ...
    driving_log = pd.read_csv('training_data/Prob_Areas/shuffled_driving_log.csv', header=None)
    images_prepend_path = 'training_data/Prob_Areas/IMG/'
    ...
    image_file_name = images_prepend_path + driving_log.ix[0][0][9:]
