...
def shuffle_driving_log():
    ...
    driving_log = pd.read_csv('training_data/Amit_Data/driving_log.csv', header=None)
    ...
    driving_log.to_csv('training_data/Amit_Data/shuffled_driving_log.csv', sep=',', header=False, index=False) #comma separated
...
def generate_data_generator(batch_size=128):
    ...
    driving_log = pd.read_csv('training_data/Amit_Data/shuffled_driving_log.csv', header=None)
    images_prepend_path = 'training_data/Amit_Data/'
    ...
    while True:
        ...
        for j in range(num_images):
            ...
            image_file_name = images_prepend_path + driving_log.ix[i][0][89:]
            ...
            image_file_name = images_prepend_path + driving_log.ix[i][1][90:]
            ...
            image_file_name = images_prepend_path + driving_log.ix[i][2][90:]       
