...
dropout_prob = 0.5
learning_rate = 0.0003 #0.001 is default for Adam
l2_reg = 1e-6 #0.00002 #1e-6 #0.0001
...
#model.load_weights('test_models/model_7.h5') #, by_name=True) #load previously save weights. don't do by_name=True for identical model. It doesn't laod the weights as the initial loss is still high doing so.
